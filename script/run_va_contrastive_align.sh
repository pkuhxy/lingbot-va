...
echo "Contrastive clean training: per_gpu_batch=8 latent_frames=4 GPUs=${NGPU} effective_global_batch=$((8 * NGPU))"
echo "Output: ${SAVE_ROOT:-/mnt/data/users/xianyi/EmbodyAi/lingbot-va/ckpts/contrastive_bs8_fn_4}"
